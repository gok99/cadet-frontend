...
const stringToActionTypeMap = {
  ...
  start_background_animation: GameActionType.StartBackgroundAnimation,
  start_object_animation: GameActionType.StartObjectAnimation,
  stop_background_animation: GameActionType.StopBackgroundAnimation,
  stop_object_animation: GameActionType.StopObjectAnimation,
